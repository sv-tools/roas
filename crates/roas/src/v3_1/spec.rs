...
impl Spec {
    ...
    /// `requestBodies`, `headers`, `examples`, `links`, and
    /// `callbacks`.
    ///
    ...
    ///
    /// [`CollapseError`]: crate::v3_1::collapse::CollapseError
    /// [`CollapseError::External`]: crate::v3_1::collapse::CollapseError::External
    /// [`CollapseError::Serialize`]: crate::v3_1::collapse::CollapseError::Serialize
    pub fn collapse(
        &mut self,
        loader: Option<&mut Loader>,
    ) -> Result<(), crate::v3_1::collapse::CollapseError> {
        crate::v3_1::collapse::collapse_spec(self, loader)
    }
}
