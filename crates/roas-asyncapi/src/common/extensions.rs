//! Serde helpers for `x-*` extension fields, matching the AsyncAPI
//! specification's
//! [Specification Extensions](https://www.asyncapi.com/docs/reference/specification/v3.0.0#specificationExtensions).
//!
//! Mirrors the analogous helper in the sibling `roas` / `roas-arazzo`
...
//!     pub foo: String,
//!     #[serde(flatten)]
//!     #[serde(with = "roas_asyncapi::common::extensions")]
