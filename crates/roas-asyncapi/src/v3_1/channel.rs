//! AsyncAPI v3.1 `Channel` object.
//!
//! Per [Channel Object](https://www.asyncapi.com/docs/reference/specification/v3.1.0#channelObject).
//!
...
use crate::v3_1::server::placeholders;
