//! AsyncAPI v3.1 `Operation`, `Operation Trait`, and reply objects.
//!
//! Per [Operation Object](https://www.asyncapi.com/docs/reference/specification/v3.1.0#operationObject).
//!
