//! AsyncAPI v3.0 `Components` object.
//!
//! Per [Components Object](https://www.asyncapi.com/docs/reference/specification/v3.0.0#componentsObject).
//!
...
use crate::v3_0::operation::{Operation, OperationReply, OperationReplyAddress, OperationTrait};
